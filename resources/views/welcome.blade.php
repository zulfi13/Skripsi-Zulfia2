...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.html">
    ...
    <div class="sidebar-brand-text mx-3" >PT.INDOPRIMA GEMILANG PLANT-1
...
<!-- Nav Item - Tables -->
<li class="nav-item">
    <a class="nav-link" href="denah.html">
...
<li class="nav-item">
    ...
    <div id="collapsePages" class="collapse" aria-labelledby="headingPages"
        data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="login.html">Kapasitas Rak</a>
            <a class="collapse-item" href="register.html">Kapasitas Material</a>
        </div>
    </div>
</li>
